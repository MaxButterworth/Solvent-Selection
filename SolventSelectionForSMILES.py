...
def Predict_Reaction_Solvent(reactant1, reactant2, product1):
    ...
    x_labels = ['Reaction Similarity Score', 'Suggested Solvent', 'Temperature Sustainability Rating', 'Yield Sustainability Rating', 'Solvent Sustainability Rating']
    y_labels = ['Reaction 1', 'Reaction 2', 'Reaction 3', 'Reaction 4', 'Reaction 5']
    
    results = [[round(sim[0], 5), solvents[indices[0]], sus_temp[indices[0]], yieldband[indices[0]], sus_solvent[indices[0]]],
               [round(sim[1], 5), solvents[indices[1]], sus_temp[indices[1]], yieldband[indices[1]], sus_solvent[indices[1]]],
               [round(sim[2], 5), solvents[indices[2]], sus_temp[indices[2]], yieldband[indices[2]], sus_solvent[indices[2]]],
               [round(sim[3], 5), solvents[indices[3]], sus_temp[indices[3]], yieldband[indices[3]], sus_solvent[indices[3]]],
               [round(sim[4], 5), solvents[indices[4]], sus_temp[indices[4]], yieldband[indices[4]], sus_solvent[indices[4]]]]
